...
Update: If you change the texture pack, you must update the direct link and the SHA-1 hash in server.properties, otherwise players might not receive the updated textures. 
